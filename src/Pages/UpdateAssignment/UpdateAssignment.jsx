            ...
            <div className='p-12' >
                ...
                <form onSubmit={handleSubmit} >
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6' >
                        <fieldset className="fieldset border-black bg-base-200  rounded-box  border p-4">
                        ...
                        <fieldset className="fieldset bg-base-200 border-black rounded-box  border p-4">
                            ...
                            <label className="label text-xl font-bold">Marks</label>
                    ...
                    <fieldset className="fieldset bg-base-200 border-black rounded-box my-6 border p-4">
                    ...
                    <input type="submit" value="Update" className='w-full btn border-black ' />
                </form>
            </div>
        </div>
    );
