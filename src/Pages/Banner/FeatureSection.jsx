            ...
            <div className='grid grid-cols-1'>
                ...
                <div className='grid lg:grid-cols-3 grid-cols-1 gap-4 my-14'  >
                    ...
                    <div className='border-2 p-3 flex flex-col '>
                        ...
                        <Link className='btn btn-secondary py-1 mt-auto' to={`/assignments/${user._id}`}  >See More</Link>
                    </div>
                    <div className='border-2 p-3 flex flex-col '>
                        ...
                        <Link className='btn btn-secondary py-1 mt-auto' to={`/giveMarks/${user._id}`}  >See More</Link>
                    </div>
                    <div className='border-2 p-3 flex flex-col '>
